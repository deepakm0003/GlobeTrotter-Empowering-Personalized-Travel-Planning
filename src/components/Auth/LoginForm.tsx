...
import { Eye, EyeOff, Mail, Lock, Globe, ArrowRight, Sparkles, Shield, Zap } from 'lucide-react';
        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl hover:shadow-blue-500/10 transition-all duration-500">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center group cursor-pointer">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-slate-600 rounded bg-slate-800/50 group-hover:border-blue-400 transition-colors duration-200"
                  />
                  <label htmlFor="remember-me" className="ml-3 block text-sm text-slate-300 group-hover:text-slate-200 transition-colors duration-200 cursor-pointer">
                    Remember me
                  </label>
                </div>
                <Link 
                  to="/forgot-password" 
                  className="text-sm font-medium text-blue-400 hover:text-blue-300 transition-all duration-200 flex items-center group hover:scale-105"
                >
                  Forgot password?
            ...
            >
              ...
              <span className="text-sm font-medium group-hover:text-white transition-colors duration-200">Sign in with Google</span>
            </button>
          </div>
